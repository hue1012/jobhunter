...
public class ResumeController {
    ...
    public ResponseEntity<ResCreateResumeDTO> create(@Valid @RequestBody Resume resume) throws IdInvalidException {
        // check id exists
        boolean isIdExist = this.resumeService.checkResumeExistsByUserAndJob(resume);
        if (isIdExist) {
            throw new IdInvalidException("Bạn đã apply công việc này rồi");
        }
    ...
    public ResponseEntity<ResultPaginationDTO> fetchAll(
        ...
        List<Long> arrJobIds = null; // tao array chua jobid
